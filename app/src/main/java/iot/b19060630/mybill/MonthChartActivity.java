...
import iot.b19060630.mybill.adapter.ChartVPAdapter;
import iot.b19060630.mybill.database.DBManager;
import iot.b19060630.mybill.frag_chart.IncomChartFragment;
import iot.b19060630.mybill.frag_chart.OutcomChartFragment;
...
//        将Fragment加载到Acitivy当中
    ...
    private void initStatistics(int year, int month) {
        ...
        dateTv.setText(year+"년"+month+"월 청구서");
        inTv.setText("총"+incountItemOneMonth+"건의 수입  ₩ "+inMoneyOneMonth);
        outTv.setText("총"+outcountItemOneMonth+"건의 지출  ₩ "+outMoneyOneMonth);
